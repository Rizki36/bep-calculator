let program = {
    ...
    getXY: function () {
        ...
        $(".tahap-group").each(function (index) {
            let x = $(this).find(".input-tahap").val(),
                y = x * program.harga;
...
$("body").on("click", ".btn-hapus", function () {
    $(this).closest(".tahap-group").remove();
    program.updateGrafik();
    program.scatterChart.update();
});
...
$(".btn-view").on("click", function (e) {
    ...
    switch (view) {
        case "btn-all":
            $("#container").removeClass("container-full-grafik");
            $("#container").removeClass("container-full-input");
            break;
        case "btn-grafik":
            $("#container").addClass("container-full-grafik");
            $("#container").removeClass("container-full-input");
            break;
        case "btn-input":
            $("#container").removeClass("container-full-grafik");
            $("#container").addClass("container-full-input");
            break;
        default:
            break;
    }
